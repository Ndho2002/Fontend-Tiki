      ...
      {loading ? (
        ...
        <>
          ...
          <div className=" py-4 bg-[#f7f7f7] dark:bg-[#18191a]">
            <div className="max-w-screen-xl px-5 mx-auto flex gap-2 items-center">
          ...
          <div className=" max-w-screen-xl px-5 mx-auto bg-white dark:bg-[#242526] py-2">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex gap-2 items-center ">
                <button
                  onClick={() => handleLike(dataBlog?._id)}
                  className={`px-2 py-1 border-[1px] ${
                    dataBlog?.likes?.find((el) => el === user?.id) &&
                    "border-[#0a68ff] text-[#0a68ff]"
                  } cursor-pointer`}
                >
                ...
                <button
                  onClick={() => handleDislike(dataBlog?._id)}
                  className={`px-2 py-1 border-[1px] ${
                    dataBlog?.dislikes?.find((el) => el === user?.id) &&
                    "border-[#0a68ff] text-[#0a68ff]"
                  } cursor-pointer`}
                >
                  <div className="flex items-center gap-2">
