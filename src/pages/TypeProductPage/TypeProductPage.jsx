  ...
  return (
    <div>
      <div className="bg-[#f5f5fa] pt-[10px] pb-[40px] dark:bg-[#18191a]">
        <div className="max-w-7xl mx-auto px-2 mb-3 flex items-center gap-2 text-[rgb(128,128,137)] dark:text-[#e4e6eb]">
          <Link to={"/"}>
        ...
        <div className="flex md:gap-5 gap-1 max-w-7xl mx-auto px-2 items-start ">
          <NavbarComponent />
