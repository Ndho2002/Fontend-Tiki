    ...
    <div className=" bg-[#efefef] py-4 dark:bg-[#18191a] min-h-screen">
      <div className=" max-w-screen-xl px-5 mx-auto">
        ...
        <div className=" bg-white mt-4 rounded p-4 dark:bg-[#242526]">
          ...
          <div className="grid grid-cols-[auto,180px,120px,120px,120px,20px] items-center gap-6 py-2 border-b-[1px]">
            <div className="flex gap-2 items-center ">
              <label htmlFor="checkAll">
                Tất cả ({location?.state?.order?.length})
              </label>
            </div>
            <div className="text-[rgb(120,120,120)] dark:text-[#e4e6eb] text-[14px] font-normal   ">
              Đơn giá
            </div>
            <div className="text-[rgb(120,120,120)] dark:text-[#e4e6eb] text-[14px] font-normal   ">
              Giảm
              ...
              return (
                <div className=" flex flex-col gap-[32px]">
                  <div className=" grid grid-cols-[auto,180px,120px,120px,120px,20px] items-center gap-6">
                    ...
                    <div className=" dark:text-[#e4e6eb] text-sm leading-[21px] font-semibold text-[rgb(39,39,42)]">
                    ...
                    <div>
                      <div className="dark:text-[#e4e6eb] flex gap-1">
                        <div>{item?.amount}</div>
                      </div>
                    </div>
