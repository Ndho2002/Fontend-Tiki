          ...
          <div className="flex flex-col gap-4 h-screen overflow-y-auto sticky">
            <div className=" rounded-xl flex flex-col gap-3 p-4 bg-white dark:bg-[#242526]">
              ...
              <div className="flex gap-11 items-center">
                ...
                <samp>{data?.discount != 0 && -data?.discount + "%"}</samp>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-4 bg-white rounded-xl p-4 dark:bg-[#242526]">
            ...
            <div className="flex gap-1">
              ...
              <input
                ...
                className="w-11 cursor-default focus:outline-none dark:text-black "
                type="number"
              />
              <button
                onClick={() =>
            ...
            <div className="flex flex-col gap-5">
              <div>
                <h2 className=" text-base font-semibold">Đơn giá:</h2>
                <h1 className=" text-2xl font-semibold">
                  {convertPrice(data?.price * number)}
